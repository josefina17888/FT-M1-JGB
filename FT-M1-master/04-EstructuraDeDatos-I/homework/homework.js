...
como primer y segundo elementos de la misma, y sabiendo que cualquier elemento que se agregue a esta secuencia será el resultado de la 
suma del último elemento y el anterior.
...
Queue.prototype.enqueue = function(elem){
  return this.miFila.push(elem);
  }
Queue.prototype.dequeue = function(){
  return this.miFila.shift();
  };
Queue.prototype.size = function(){
  return this.miFila.length;
  };
